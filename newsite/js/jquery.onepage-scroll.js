...
//TRIGER SKILLS ON ONE PAGE WITH NORMAL SCROLL
if( $('.initskills').length ){
      ...
      if (valForTest) {
        ...
        $(document).bind('mousewheel DOMMouseScroll MozMousePixelScroll', function(event) {
          ...
          if( $('.page4').hasClass('active') ){
            ...
            //!Note: There is also another triger for mobile devices

          if( $('.page1').hasClass('active') ){
            if($p1 == 1){
              sound();
              $p1 = 0;$p2 = 1;$p3 = 1;$p4 = 1;$p5 = 1;
            }
          }
          if( $('.page2').hasClass('active') ){
            if($p2 == 1){
              sound();
              $p1 = 1;$p2 = 0;$p3 = 1;$p4 = 1;$p5 = 1;
            }
          }
